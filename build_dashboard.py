...
function openBrief(id,biz){
  ...
  const portalHtml='<!DOCTYPE html><html><head><meta charset="UTF-8"/><title>'+esc(biz)+' &#x2014; Sales Portal</title>'
    ...
    +'</div>'
    +'<script>function showTab(btn,id){document.querySelectorAll(".tab-body").forEach(function(t){t.style.display="";t.classList.remove("active")});document.querySelectorAll(".tab-btn").forEach(function(b){b.classList.remove("active")});document.getElementById("tab-"+id).classList.add("active");btn.classList.add("active");}function showOTab(btn,id){document.querySelectorAll(".otab-pane").forEach(function(p){p.classList.remove("active")});document.querySelectorAll(".otab-btn").forEach(function(b){b.classList.remove("active")});var el=document.getElementById("otab-"+id);if(el)el.classList.add("active");btn.classList.add("active");}function scriptNav(btn,id){var f=document.getElementById("stratIframe");if(f&&f.contentDocument){var el=f.contentDocument.getElementById(id);if(el)el.scrollIntoView({behavior:"smooth",block:"start"});}document.querySelectorAll(".snav-btn").forEach(function(b){b.classList.remove("active")});btn.classList.add("active");}function doCopy(btnId,txtId){var t=document.getElementById(txtId).innerText;if(navigator.clipboard){navigator.clipboard.writeText(t).then(function(){var b=document.getElementById(btnId);b.textContent="Copied!";setTimeout(function(){b.textContent="📋 Copy";},2000);});}else{var r=document.createRange();r.selectNodeContents(document.getElementById(txtId));window.getSelection().removeAllRanges();window.getSelection().addRange(r);document.execCommand("copy");}}function openWhyModal(){document.getElementById("whyModal").classList.add("open");}function closeWhyModal(){document.getElementById("whyModal").classList.remove("open");}document.getElementById("whyModal").addEventListener("click",function(e){if(e.target===this)closeWhyModal();});function openGlossaryModal(){document.getElementById("glossaryModal").classList.add("open");}function closeGlossaryModal(){document.getElementById("glossaryModal").classList.remove("open");}document.getElementById("glossaryModal").addEventListener("click",function(e){if(e.target===this)closeGlossaryModal();});function openPostSale(btn){var emojis=["💰","💵","🤑","💸","✅","🎉"];var r=btn.getBoundingClientRect();for(var i=0;i<10;i++){(function(i){setTimeout(function(){var p=document.createElement("div");p.className="money-particle";p.textContent=emojis[Math.floor(Math.random()*emojis.length)];p.style.left=(r.left+Math.random()*r.width)+"px";p.style.top=(r.top-10)+"px";p.style.animationDuration=(0.8+Math.random()*0.7)+"s";document.body.appendChild(p);setTimeout(function(){p.remove();},1500);},i*80);})(i);}setTimeout(function(){var w=window.open("","_blank");var biz=document.querySelector(".hdr-title")?document.querySelector(".hdr-title").innerText:"Client";w.document.write(buildPostSaleHtml(biz));w.document.close();},300);}function buildPostSaleHtml(biz){var css="*{box-sizing:border-box;margin:0;padding:0}body{font-family:\'DM Sans\',sans-serif;background:#060b18;color:#c8d8e8;min-height:100vh;padding:0 0 60px}body::before{content:\'\';position:fixed;inset:0;background-image:linear-gradient(rgba(0,212,255,.02) 1px,transparent 1px),linear-gradient(90deg,rgba(0,212,255,.02) 1px,transparent 1px);background-size:40px 40px;pointer-events:none;z-index:0}.hdr{background:linear-gradient(135deg,#0a1f0a,#0d1f2d);border-bottom:2px solid rgba(16,185,129,.4);padding:28px 40px;position:relative;z-index:1}.hdr h1{font-family:\'Syne\',sans-serif;font-size:26px;font-weight:800;color:#10b981;letter-spacing:1px;margin-bottom:4px}.hdr p{font-size:14px;color:#4a9070;font-weight:500}.content{max-width:900px;margin:0 auto;padding:32px 40px;position:relative;z-index:1}h2{font-family:\'Syne\',sans-serif;font-size:17px;font-weight:700;color:#00d4ff;letter-spacing:1px;margin:32px 0 14px;padding-bottom:8px;border-bottom:1px solid rgba(0,212,255,.15)}.tl-wrap{position:relative;display:flex;align-items:flex-start;background:#0d1528;border:1px solid rgba(0,212,255,.12);border-radius:6px;padding:24px 16px 20px;margin-bottom:28px}.tl-line{position:absolute;top:43px;left:9%;right:9%;height:2px;background:linear-gradient(90deg,#10b981,rgba(0,212,255,.4))}.tl-step{flex:1;display:flex;flex-direction:column;align-items:center;position:relative;z-index:1;padding:0 4px}.tl-num{width:36px;height:36px;border-radius:50%;background:linear-gradient(135deg,#10b981,#00c896);color:#060b18;font-family:\'Syne\',sans-serif;font-size:14px;font-weight:800;display:flex;align-items:center;justify-content:center;margin-bottom:8px;box-shadow:0 0 10px rgba(16,185,129,.35)}.tl-label{font-size:10px;font-weight:600;color:#7aa0b8;text-align:center;margin-bottom:6px;line-height:1.4}.tl-owners{display:flex;flex-wrap:wrap;gap:3px;justify-content:center}.ot{font-size:9px;font-weight:600;padding:2px 6px;border-radius:10px}.ot-c{background:rgba(245,196,0,.12);color:#f5c400;border:1px solid rgba(245,196,0,.25)}.ot-z{background:rgba(192,132,252,.12);color:#c084fc;border:1px solid rgba(192,132,252,.25)}.ot-d{background:rgba(0,212,255,.1);color:#00d4ff;border:1px solid rgba(0,212,255,.2)}.ob-wrap{text-align:center;margin-bottom:32px}.ob-btn{display:inline-block;background:linear-gradient(135deg,rgba(16,185,129,.2),rgba(0,212,255,.1));border:2px solid rgba(16,185,129,.5);color:#10b981;padding:14px 36px;border-radius:6px;font-family:\'Syne\',sans-serif;font-size:15px;font-weight:700;letter-spacing:.5px;text-decoration:none}.ob-note{font-size:12px;color:#2a5a48;margin-top:8px}.step{background:#0d1528;border:1px solid rgba(0,212,255,.12);border-left:4px solid #10b981;border-radius:6px;padding:20px 24px;margin-bottom:14px}.step-hdr{display:flex;align-items:center;gap:10px;margin-bottom:14px;flex-wrap:wrap}.snum{width:30px;height:30px;border-radius:50%;background:rgba(16,185,129,.1);border:2px solid rgba(16,185,129,.35);color:#10b981;font-family:\'Syne\',sans-serif;font-size:13px;font-weight:800;display:flex;align-items:center;justify-content:center;flex-shrink:0}.stitle{font-family:\'Syne\',sans-serif;font-size:14px;font-weight:700;color:#00ff9d;flex:1}.sowns{display:flex;gap:4px;flex-wrap:wrap}.smain{font-size:15px;color:#c8d8e8;line-height:1.8;margin-bottom:12px}.stech{font-size:11px;color:#2e4a5e;line-height:1.7;border-top:1px solid rgba(0,212,255,.07);padding-top:9px}.stech strong{color:#3a6070;font-weight:600}.pricing{display:grid;grid-template-columns:1fr 1fr 1fr;gap:16px;margin-top:16px}.pcard{background:#0d1528;border:1px solid rgba(0,212,255,.12);border-top:4px solid #10b981;border-radius:6px;padding:20px}.pcard h3{font-family:\'Syne\',sans-serif;font-size:14px;font-weight:700;color:#c8d8e8;margin-bottom:2px}.pcard .sub{font-size:11px;color:#4a7080;margin-bottom:10px}.pcard .price{font-size:22px;font-weight:700;color:#10b981;margin:10px 0}.pcard ul{list-style:disc;margin-left:16px}.pcard li{font-size:12px;color:#8ab0c8;line-height:1.6;margin-bottom:3px}.alert{background:rgba(245,158,11,.07);border-left:4px solid #f59e0b;border-radius:0 6px 6px 0;padding:12px 18px;margin:16px 0;font-size:13px;color:#c8a840;line-height:1.6}.upsell{margin:0 0 0 18px}.upsell li{font-size:13px;color:#8ab0c8;line-height:1.6;margin-bottom:8px}.upsell strong{color:#f5c400}";var h="<!DOCTYPE html><html><head><meta charset=\'UTF-8\'><title>Post Sale — "+biz+"<\/title><link href=\'https://fonts.googleapis.com/css2?family=DM+Sans:wght@300;400;500;600&family=Syne:wght@700;800&display=swap\' rel=\'stylesheet\'><style>"+css+"<\/style><\/head><body>";h+="<div class=\'hdr\'><h1>&#x1F4B0; Post Sale — Next Steps<\/h1><p>Client: "+biz+" &nbsp;·&nbsp; Walk through this with your client after they buy<\/p><\/div>";h+="<div class=\'content\'>";h+="<h2>How the Process Works<\/h2>";h+="<div class=\'tl-wrap\'><div class=\'tl-line\'><\/div>";h+="<div class=\'tl-step\'><div class=\'tl-num\'>1<\/div><div class=\'tl-label\'>Onboarding &amp; Info Gathering<\/div><div class=\'tl-owners\'><span class=\'ot ot-c\'>Client<\/span><span class=\'ot ot-z\'>Zee<\/span><span class=\'ot ot-d\'>Dev<\/span><\/div><\/div>";h+="<div class=\'tl-step\'><div class=\'tl-num\'>2<\/div><div class=\'tl-label\'>Development &amp; Build<\/div><div class=\'tl-owners\'><span class=\'ot ot-d\'>Dev<\/span><\/div><\/div>";h+="<div class=\'tl-step\'><div class=\'tl-num\'>3<\/div><div class=\'tl-label\'>QA &amp; Client Review<\/div><div class=\'tl-owners\'><span class=\'ot ot-d\'>Dev<\/span><\/div><\/div>";h+="<div class=\'tl-step\'><div class=\'tl-num\'>4<\/div><div class=\'tl-label\'>Deployment &amp; Handover<\/div><div class=\'tl-owners\'><span class=\'ot ot-d\'>Dev<\/span><\/div><\/div>";h+="<div class=\'tl-step\'><div class=\'tl-num\'>5<\/div><div class=\'tl-label\'>Post-Launch Support<\/div><div class=\'tl-owners\'><span class=\'ot ot-z\'>Zee<\/span><span class=\'ot ot-d\'>Dev<\/span><span class=\'ot ot-c\'>Client<\/span><\/div><\/div>";h+="<\/div>";h+="<div class=\'ob-wrap\'><a href=\'https://forms.gle/RYJQ1JQ3eMJQXbA97\' target=\'_blank\' class=\'ob-btn\'>&#x1F4CB;&nbsp; Onboarding Form for Client &nbsp;&#x2192;<\/a><div class=\'ob-note\'>Send this link to your client right now — takes 5–10 minutes to fill out<\/div><\/div>";h+="<h2>Step-by-Step Breakdown<\/h2>";h+="<div class=\’step\’><div class=\’step-hdr\’><div class=\’snum\’>1<\/div><div class=\’stitle\’>Onboarding &amp; Information Gathering<\/div><div class=\’sowns\’><span class=\’ot ot-c\’>Client<\/span><span class=\’ot ot-z\’>Zee<\/span><span class=\’ot ot-d\’>Dev<\/span><\/div><\/div><div class=\’smain\’>We\’ll send you a quick form to fill out. It covers your logo, your business details, the services you want listed, and any photos you\’d like on the site. Once that\’s done, we have everything we need to get started. Takes about 5–10 minutes on your end.<\/div><div class=\’stech\’><strong>What we collect:<\/strong> Domain access &middot; Logo &amp; brand colors &middot; Service list &middot; Address &amp; phone &middot; Any photos or existing copy<\/div><\/div>";h+="<div class=\’step\’><div class=\’step-hdr\’><div class=\’snum\’>2<\/div><div class=\’stitle\’>Development, Configuration &amp; Optimization<\/div><div class=\’sowns\’><span class=\’ot ot-d\’>Dev<\/span><\/div><\/div><div class=\’smain\’>Our team takes everything you sent and builds the site. You don\’t need to do anything here — we handle the design, your service pages, your contact form, and make sure Google can find you. We\’ll have a preview ready for you shortly.<\/div><div class=\'stech\'><strong>Under the hood:<\/strong> Hosting &amp; environment setup &middot; Core pages (Home, Services, Contact) &middot; Lead intake form &middot; Image optimization &middot; Meta tags &amp; sitemap &middot; SSL certificate<\/div><\/div>";h+="<div class=\'step\'><div class=\'step-hdr\'><div class=\'snum\'>3<\/div><div class=\'stitle\'>Quality Assurance &amp; Client Review<\/div><div class=\'sowns\'><span class=\'ot ot-d\'>Dev<\/span><\/div><\/div><div class=\'smain\'>Before anything goes live, we send you a preview link so you can see exactly how the site looks. Take a look, tell us what you\’d like changed — a photo, some wording, a color. We fix it. Nothing goes live until you\’re happy with it.<\/div><div class=\'stech\'><strong>What we check:<\/strong> Mobile, tablet &amp; desktop testing &middot; Form submissions &middot; Page load speed &middot; Staging link sent for your approval<\/div><\/div>";h+="<div class=\'step\'><div class=\'step-hdr\'><div class=\'snum\'>4<\/div><div class=\'stitle\'>Deployment &amp; Handover<\/div><div class=\'sowns\'><span class=\'ot ot-d\'>Dev<\/span><\/div><\/div><div class=\'smain\'>Once you\’ve approved it, we flip the switch. Your site goes live at your web address. We\’ll walk you through what you\’ve got — where to find things and how to reach us if something comes up.<\/div><div class=\'stech\'><strong>Going live:<\/strong> DNS pointed to the new site &middot; Production mode enabled &middot; Login credentials delivered &middot; Quick orientation walkthrough<\/div><\/div>";h+="<div class=\'step\'><div class=\'step-hdr\'><div class=\'snum\'>5<\/div><div class=\'stitle\'>Post-Launch Support<\/div><div class=\'sowns\'><span class=\'ot ot-z\'>Zee<\/span><span class=\'ot ot-d\'>Dev<\/span><span class=\'ot ot-c\'>Client<\/span><\/div><\/div><div class=\'smain\'>We keep an eye on things for the first few weeks after launch. If anything breaks or you want a small change, just reach out and we\’ve got you. Your site is backed up automatically so nothing is ever lost.<\/div><div class=\'stech\'><strong>Behind the scenes:<\/strong> Uptime monitoring &middot; Automated backups &middot; Bug patching &middot; 1–3 month support window<\/div><\/div>";h+="<h2>Website Care &amp; Maintenance Plans — Pitch These<\/h2>";h+="<div class=\'pricing\'><div class=\'pcard\'><h3>Basic Care<\/h3><div class=\'sub\'>Simple \/ Static Sites<\/div><div class=\'price\'>$99 <span style=\'font-size:14px;font-weight:400\'>/mo<\/span><\/div><ul><li>Uptime guarantee<\/li><li>Basic content updates (&lt;30 min/mo)<\/li><li>Domain &amp; auto-SSL<\/li><\/ul><\/div><div class=\'pcard\' style=\'border-top-color:#3b82f6\'><h3>Standard Care<\/h3><div class=\'sub\'>Dynamic \/ SMB Sites<\/div><div class=\'price\' style=\'color:#60a5fa\'>$175 <span style=\'font-size:14px;font-weight:400\'>/mo<\/span><\/div><ul><li>Analytics monitoring<\/li><li>Automated backups<\/li><li>Minor bug fixes<\/li><li>SEO &amp; speed tuning<\/li><\/ul><\/div><div class=\'pcard\' style=\'border-top-color:#8b5cf6\'><h3>Premium Care<\/h3><div class=\'sub\'>E-commerce \/ Complex<\/div><div class=\'price\' style=\'color:#a78bfa\'>$250 <span style=\'font-size:14px;font-weight:400\'>/mo<\/span><\/div><ul><li>Real-time monitoring<\/li><li>Immediate issue resolution<\/li><li>Payment security<\/li><li>API &amp; data optimization<\/li><\/ul><\/div><\/div>";h+="<h2>Additional Upsell Opportunities<\/h2>";h+="<div class=\'alert\'><strong>Timing:<\/strong> Pitch these within <strong>2 weeks<\/strong> of closing — while momentum is high.<\/div>";h+="<ul class=\'upsell\'><li><strong>CMS Integration<\/strong> — Client can update their own content without calling us.<\/li><li><strong>AI Chatbot \/ Lead Intake<\/strong> — Captures after-hours enquiries automatically.<\/li><li><strong>Booking System<\/strong> — Full appointment scheduling with calendar sync. Big value for trade businesses.<\/li><li><strong>E-commerce<\/strong> — Add online payments for deposits or job quotes.<\/li><li><strong>Custom Features<\/strong> — We can build virtually anything. Custom quote after a quick requirements chat.<\/li><\/ul>";h+="<\/div><\/body><\/html>";return h;};<\/script>'
    +'</body></html>';
