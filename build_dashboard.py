...
function openBrief(id,biz){
  ...
  const B='<strong style="color:#f5c400;font-weight:700">';const BE='<\/strong>';
  const I='<em style="color:#00ff9d;font-style:normal;font-weight:600">';const IE='<\/em>';
  const SH='<div style="font-family:\'Syne\',sans-serif;font-size:11px;font-weight:700;letter-spacing:2px;text-transform:uppercase;padding:10px 14px;margin:0 -2px 14px;border-radius:3px">';
  ...
  const anglesHtml=''
    +SH+'style="background:rgba(0,255,157,.07);border-left:3px solid #00ff9d;color:#00ff9d">&#x1F504; REDESIGNED — NEW WEBSITE<\/div>'
    ...
    +SH+'style="background:rgba(248,113,113,.07);border-left:3px solid #f87171;color:#f87171;margin-top:8px">&#x274C; CURRENTLY NO WEBSITE<\/div>'
