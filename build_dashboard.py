...
function openBrief(id,biz){
  ...
  const portalHtml='<!DOCTYPE html><html><head><meta charset="UTF-8"/><title>'+esc(biz)+' &#x2014; Sales Portal</title>'
    ...
    +'</div>'
    +'<script>function showTab(btn,id){document.querySelectorAll(".tab-body").forEach(function(t){t.style.display="";t.classList.remove("active")});document.querySelectorAll(".tab-btn").forEach(function(b){b.classList.remove("active")});document.getElementById("tab-"+id).classList.add("active");btn.classList.add("active");}function showOTab(btn,id){document.querySelectorAll(".otab-pane").forEach(function(p){p.classList.remove("active")});document.querySelectorAll(".otab-btn").forEach(function(b){b.classList.remove("active")});var el=document.getElementById("otab-"+id);if(el)el.classList.add("active");btn.classList.add("active");}function scriptNav(btn,id){var f=document.getElementById("stratIframe");if(f&&f.contentDocument){var el=f.contentDocument.getElementById(id);if(el)el.scrollIntoView({behavior:"smooth",block:"start"});}document.querySelectorAll(".snav-btn").forEach(function(b){b.classList.remove("active")});btn.classList.add("active");}function doCopy(btnId,txtId){var t=document.getElementById(txtId).innerText;if(navigator.clipboard){navigator.clipboard.writeText(t).then(function(){var b=document.getElementById(btnId);b.textContent="Copied!";setTimeout(function(){b.textContent="📋 Copy";},2000);});}else{var r=document.createRange();r.selectNodeContents(document.getElementById(txtId));window.getSelection().removeAllRanges();window.getSelection().addRange(r);document.execCommand("copy");}}function openWhyModal(){document.getElementById("whyModal").classList.add("open");}function closeWhyModal(){document.getElementById("whyModal").classList.remove("open");}document.getElementById("whyModal").addEventListener("click",function(e){if(e.target===this)closeWhyModal();});function openGlossaryModal(){document.getElementById("glossaryModal").classList.add("open");}function closeGlossaryModal(){document.getElementById("glossaryModal").classList.remove("open");}document.getElementById("glossaryModal").addEventListener("click",function(e){if(e.target===this)closeGlossaryModal();});function openPostSale(btn){var emojis=["💰","💵","🤑","💸","✅","🎉"];var r=btn.getBoundingClientRect();for(var i=0;i<10;i++){(function(i){setTimeout(function(){var p=document.createElement("div");p.className="money-particle";p.textContent=emojis[Math.floor(Math.random()*emojis.length)];p.style.left=(r.left+Math.random()*r.width)+"px";p.style.top=(r.top-10)+"px";p.style.animationDuration=(0.8+Math.random()*0.7)+"s";document.body.appendChild(p);setTimeout(function(){p.remove();},1500);},i*80);})(i);}setTimeout(function(){var w=window.open("","_blank");var biz=document.querySelector(".hdr-title")?document.querySelector(".hdr-title").innerText:"Client";w.document.write(buildPostSaleHtml(biz));w.document.close();},300);}function buildPostSaleHtml(biz){return"<!DOCTYPE html><html><head><meta charset=\'UTF-8\'><title>Post Sale — "+biz+"<\/title><link href=\'https://fonts.googleapis.com/css2?family=DM+Sans:wght@400;500;600&family=Syne:wght@700;800&display=swap\' rel=\'stylesheet\'><style>*{box-sizing:border-box;margin:0;padding:0}body{font-family:\'DM Sans\',sans-serif;background:#060b18;color:#c8d8e8;min-height:100vh;padding:0 0 60px}body::before{content:\'\';position:fixed;inset:0;background-image:linear-gradient(rgba(0,212,255,.02) 1px,transparent 1px),linear-gradient(90deg,rgba(0,212,255,.02) 1px,transparent 1px);background-size:40px 40px;pointer-events:none;z-index:0}.hdr{background:linear-gradient(135deg,#0a1f0a,#0d1f2d);border-bottom:2px solid rgba(16,185,129,.4);padding:28px 40px;position:relative;z-index:1}.hdr h1{font-family:\'Syne\',sans-serif;font-size:28px;font-weight:800;color:#10b981;letter-spacing:1px;margin-bottom:4px}.hdr p{font-size:14px;color:#4a9070;font-weight:500}.content{max-width:900px;margin:0 auto;padding:32px 40px;position:relative;z-index:1}h2{font-family:\'Syne\',sans-serif;font-size:18px;font-weight:700;color:#00d4ff;letter-spacing:1px;margin:36px 0 16px;padding-bottom:8px;border-bottom:1px solid rgba(0,212,255,.15)}.step{background:#0d1528;border:1px solid rgba(0,212,255,.15);border-left:4px solid #10b981;border-radius:6px;padding:20px 24px;margin-bottom:14px}.step h3{font-family:\'Syne\',sans-serif;font-size:15px;font-weight:700;color:#00ff9d;margin-bottom:8px}.step p{font-size:13px;color:#8ab0c8;line-height:1.7;margin-bottom:8px}.step ul{margin:6px 0 0 18px;list-style:disc}.step li{font-size:13px;color:#8ab0c8;line-height:1.6;margin-bottom:4px}.step strong{color:#f5c400}.pricing{display:grid;grid-template-columns:1fr 1fr 1fr;gap:16px;margin-top:16px}.pcard{background:#0d1528;border:1px solid rgba(0,212,255,.12);border-top:4px solid #10b981;border-radius:6px;padding:20px}.pcard h3{font-family:\'Syne\',sans-serif;font-size:14px;font-weight:700;color:#c8d8e8;margin-bottom:2px}.pcard .sub{font-size:11px;color:#4a7080;margin-bottom:10px}.pcard .price{font-size:22px;font-weight:700;color:#10b981;margin:10px 0}.pcard ul{list-style:disc;margin-left:16px}.pcard li{font-size:12px;color:#8ab0c8;line-height:1.6;margin-bottom:3px}.alert{background:rgba(245,158,11,.07);border-left:4px solid #f59e0b;border-radius:0 6px 6px 0;padding:12px 18px;margin:16px 0;font-size:13px;color:#c8a840;line-height:1.6}.upsell li{font-size:13px;color:#8ab0c8;line-height:1.6;margin-bottom:8px}.upsell strong{color:#f5c400}<\/style><\/head><body>"+"<div class=\'hdr\'><h1>💰 Post Sale — Next Steps<\/h1><p>Client: "+biz+" &nbsp;|&nbsp; Use this guide to set clear expectations and maximise the relationship<\/p><\/div>"+"<div class=\'content\'><h2>The 5-Step Handover Process<\/h2>"+"<div class=\'step\'><h3>Step 1 — Onboarding &amp; Information Gathering<\/h3><p>Lay the groundwork by collecting everything needed to kick off implementation.<\/p><ul><li><strong>Infrastructure:<\/strong> Domain name + hosting\/server access (AWS, Vercel, VPS)<\/li><li><strong>Branding:<\/strong> Logo, brand colours, typography, address, phone, business email<\/li><li><strong>Content:<\/strong> Service list, photos, any existing copy they want to keep<\/li><\/ul><\/div>"+"<div class=\'step\'><h3>Step 2 — Development, Configuration &amp; Optimisation<\/h3><p>Turning the approved build into a production-ready site.<\/p><ul><li><strong>Setup:<\/strong> Repos, environments (.env), databases if needed<\/li><li><strong>Build:<\/strong> Core pages (Home, Services, Contact) + booking form, lead intake<\/li><li><strong>Optimise:<\/strong> Core Web Vitals, image compression, meta tags, sitemaps, SSL<\/li><\/ul><\/div>"+"<div class=\'step\'><h3>Step 3 — Quality Assurance &amp; Client Review<\/h3><p>Ensuring the site is flawless before launch.<\/p><ul><li><strong>Testing:<\/strong> All devices (mobile, tablet, desktop) + form submissions, load times<\/li><li><strong>Preview:<\/strong> Deployed to staging URL — client reviews and requests final changes<\/li><\/ul><\/div>"+"<div class=\'step\'><h3>Step 4 — Deployment &amp; Handover<\/h3><p>Taking the site live.<\/p><ul><li><strong>Go-Live:<\/strong> DNS pointed to production server, debug logs off, production mode on<\/li><li><strong>Handover:<\/strong> Client receives login credentials and a brief walkthrough<\/li><\/ul><\/div>"+"<div class=\'step\'><h3>Step 5 — Post-Launch Support<\/h3><p>Stability window immediately after go-live.<\/p><ul><li><strong>Warranty:<\/strong> 1–3 month monitoring window to patch any unforeseen issues<\/li><li><strong>Backups:<\/strong> Automated database + code backups configured from day one<\/li><\/ul><\/div>"+"<h2>Website Care &amp; Maintenance Plans — Pitch These<\/h2><div class=\'pricing\'><div class=\'pcard\'><h3>Basic Care<\/h3><div class=\'sub\'>Landing \/ Static Sites<\/div><div class=\'price\'>$99 <span style=\'font-size:14px;font-weight:400\'>\/mo<\/span><\/div><ul><li>Uptime guarantee<\/li><li>Basic content updates (&lt;30 min\/mo)<\/li><li>Domain &amp; auto-SSL config<\/li><\/ul><\/div><div class=\'pcard\' style=\'border-top-color:#3b82f6\'><h3>Standard Care<\/h3><div class=\'sub\'>Dynamic \/ Blog \/ SMB<\/div><div class=\'price\' style=\'color:#60a5fa\'>$175 <span style=\'font-size:14px;font-weight:400\'>\/mo<\/span><\/div><ul><li>Vercel Analytics monitoring<\/li><li>Automated DB backups<\/li><li>Minor bug fixes<\/li><li>SEO &amp; speed optimisation<\/li><\/ul><\/div><div class=\'pcard\' style=\'border-top-color:#8b5cf6\'><h3>Premium Care<\/h3><div class=\'sub\'>E-commerce \/ Complex<\/div><div class=\'price\' style=\'color:#a78bfa\'>$250 <span style=\'font-size:14px;font-weight:400\'>\/mo<\/span><\/div><ul><li>Real-time monitoring<\/li><li>Immediate issue resolution<\/li><li>Payment gateway security<\/li><li>API &amp; data optimisation<\/li><\/ul><\/div><\/div>"+"<h2>Additional Upsell Opportunities<\/h2><div class=\'alert\'><strong>Timing:<\/strong> Pitch these within <strong>2 weeks<\/strong> of the client agreeing to buy — while momentum is high.<\/div><ul class=\'upsell\'><li><strong>CMS Integration<\/strong> — Client can add\/edit\/delete content themselves. Removes reliance on us for updates.<\/li><li><strong>AI Chatbot \/ Lead Intake<\/strong> — Intelligent chatbot handles after-hours enquiries and captures leads automatically.<\/li><li><strong>Booking System<\/strong> — Full appointment scheduling with calendar sync. Huge value for trade businesses with appointment-based jobs.<\/li><li><strong>E-commerce Conversion<\/strong> — Add product sales or online payment for deposits and quotes.<\/li><li><strong>Custom Features<\/strong> — We can build virtually anything. Custom quote after requirement analysis.<\/li><\/ul><\/div><\/body><\/html>";};<\/script>'
    +'</body></html>';
